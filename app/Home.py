...
# ── Page routing switcher for single page app ──
page = st.query_params.get("page", "home")

if page == "upcoming" or page == "completed":
    from app.views.matches import render_view as render_matches
    render_matches()
elif page == "detail":
    from app.views.detail import render_view as render_detail
    render_detail()
elif page == "accuracy":
    from app.views.accuracy import render_view as render_accuracy
    render_accuracy()
elif page == "bracket":
